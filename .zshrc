...
alias blih='blih -u lucas.fabre@epitech.eu'
alias ns_auth='ns_auth -u lucas.fabre@epitech.eu'
alias ne='emacs -nw'
alias vi='vim'
alias gcc="gcc -W -Wall -Wextra"
alias g++="g++ -W -Wall -Wextra"
alias del="rmtrash"
alias Make="make re ; make clean"

export PATH=$PATH:~/.bin:~/.local/bin


source "/home/lucas/.oh-my-zsh/custom/themes/spaceship.zsh-theme"

[ -z "$TMUX"  ] && { tmux new-session || exec tmux new-session && exit;}
